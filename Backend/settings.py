...
SECRET_KEY = "django-insecure-w!5az-c%b4$npr+!ya$b6iqoy$=s%u1$%ng()cy3x21y%zjhn^"
...
CORS_ALLOWED_ORIGINS = [ # React app's dev server
 'http://localhost:5173',
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "newtique"),
